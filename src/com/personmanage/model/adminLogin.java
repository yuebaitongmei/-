...
public class adminLogin extends dbconnector {
	...
	public admin Login(admin ad) {
		...
		try {
			...
			operator.setString(2, code.encode(ad.getPassword()));
			...
			if (dbResult.next()) {
				...
				resultAdmin.setPassword((code.decode(dbResult.getString("password"))));
			}
	...
	public String editpassword1(admin ad, String newpassword) {
		...
		try {
			...
			operator.setString(3, code.encode(ad.getPassword()));
		...
		try {
			...
			operator2.setString(3,code.encode( ad.getPassword()));
